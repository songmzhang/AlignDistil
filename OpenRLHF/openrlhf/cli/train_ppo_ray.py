        ...
        for _ in reward_pretrains:
            reward_models.append(
                PPORayActorGroup(
                    ...
                    RewardModelRayActor if not args.token_level_dpo_reward else ReferenceModelRayActor,
                    pg=pg,
                    num_gpus_per_actor=0.25 if pg else 1,
                )
            )
...
if __name__ == "__main__":
    ...
    parser.add_argument("--token_level_dpo_reward", action="store_true", default=False, help="Whether use RTO")
    parser.add_argument("--beta", type=float, default=0.1, help="DPO reward coefficient")
    ...
    parser.add_argument("--ref_model", type=str, default=None, help="HF model name or path")
